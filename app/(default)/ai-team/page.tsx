...
export const metadata: Metadata = {
  title: "AI Team | Narxu - Meet Your Virtual Workforce",
  description:
    "Meet Narxu's AI team members. Specialized AI agents for customer support, sales, scheduling, and more. Available 24/7.",
  keywords: [
    "AI team",
    "virtual assistants",
    "AI agents",
  ...
  openGraph: {
    title: "AI Team | Narxu",
    description: "Meet your virtual AI workforce powered by Narxu.",
    type: "website",
  },
};
...
const aiAgents = [
  {
    ...
    icon: HeadphonesIcon,
    description:
      "Handles customer inquiries, resolves issues, and provides instant support across all channels.",
    skills: [
      "Issue Resolution",
      "Product Knowledge",
      "Escalation Handling",
  ...
  },
  {
    ...
    icon: TrendingUp,
    description:
      "Qualifies leads, recommends products, and guides customers through the purchase journey.",
    skills: [
      "Lead Qualification",
  ...
  },
  {
    ...
    icon: Calendar,
    description:
      "Manages appointments, sends reminders, and optimizes scheduling for maximum efficiency.",
    skills: [
      "Appointment Booking",
      "Calendar Sync",
      "Reminders",
  ...
  },
  {
    ...
    icon: ShoppingCart,
    description:
      "Assists shoppers with product discovery, cart management, and order tracking.",
    skills: [
      "Product Search",
      "Cart Recovery",
      "Order Tracking",
  ...
  },
  {
    ...
    icon: FileSearch,
    description:
      "Searches and retrieves information from your knowledge base with perfect accuracy.",
    skills: [
      "Document Search",
      "FAQ Handling",
      "Content Suggestions",
  ...
  },
  {
    ...
    icon: Shield,
    description:
      "Monitors conversations for compliance, detects fraud, and ensures data security.",
    skills: [
      "Fraud Detection",
      "Compliance Check",
      "Data Protection",
...
const capabilities = [
  {
    ...
    description: "Get your AI team running in minutes",
  },
  {
    icon: Settings,
    title: "Fully Customizable",
    description: "Train agents on your specific needs",
  },
  {
    icon: Users,
...
const testimonials = [
  {
    quote:
      "Our AI team handles 80% of inquiries without human intervention. It's transformed our support.",
  ...
  {
    quote:
      "The sales AI increased our conversion rate by 45%. ROI was achieved within the first month.",
    author: "Michael Chen",
    role: "Sales Director",
    company: "GrowthLabs",
    rating: 5,
  ...
  {
    quote:
      "Scheduling automation saved our team 40 hours per week. Our clients love the instant booking.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-white/60 max-w-3xl mx-auto mb-12">
              Meet the AI agents that work tirelessly to help your business
              succeed. Specialized, trained, and ready to deploy.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {aiAgents.map((agent, index) => (
              ...
              >
                {/* Agent Header */}
                <div
                  className={`relative h-32 bg-gradient-to-br ${agent.color} opacity-80`}
                >
              ...
              {[
                {
                  step: "01",
                  title: "Choose Agents",
                  description: "Select the AI team members that fit your needs",
                },
                {
                  step: "02",
                ...
                },
                {
                  ...
                  description: "Connect to your existing tools and channels",
                },
                {
                  step: "04",
          ...
          <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-3xl p-8 md:p-12 text-center">
            ...
            <p className="text-white/60 mb-8 max-w-2xl mx-auto">
              Start with a free trial and see how AI agents can transform your
              business operations.
            </p>
