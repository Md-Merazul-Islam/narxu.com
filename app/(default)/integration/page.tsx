...
export const metadata: Metadata = {
  title: "Integrations | Narxu - Connect Your Tools & Platforms",
  description:
    "Integrate Narxu AI with your existing tools. Seamless connections with Slack, Salesforce, Zendesk, and 100+ more platforms.",
  keywords: [
    "integrations",
    "API",
    "Slack",
  ...
  openGraph: {
    title: "Integrations | Narxu",
    description: "Connect Narxu AI with your existing tools and platforms.",
    type: "website",
  },
};
...
const featuredIntegrations = [
  {
    ...
    description:
      "Deploy AI agents directly in your Slack workspace for instant team and customer support.",
    logo: "/slack-logo.png",
    popular: true,
  },
  {
    ...
    category: "CRM",
    description:
      "Sync conversations and customer data seamlessly with Salesforce for complete visibility.",
  ...
  },
  {
    ...
    category: "Support",
    description:
      "Enhance your Zendesk support with AI-powered ticket routing and response suggestions.",
  ...
  },
  {
    ...
    category: "Communication",
    description:
      "Bring AI assistance to your Teams channels for internal and external communications.",
  ...
  },
  {
    ...
    category: "CRM",
    description:
      "Connect your HubSpot CRM for automated lead qualification and customer insights.",
  ...
  },
  {
    ...
    category: "Support",
    description:
      "Supercharge your Intercom messenger with AI-powered automated responses.",
...
const apiFeatures = [
  {
    ...
    title: "RESTful API",
    description:
      "Full-featured REST API for complete programmatic access to all Narxu features.",
  },
  {
    icon: Webhook,
    title: "Webhooks",
  ...
  },
  {
    ...
    title: "Data Export",
    description:
      "Export conversation data, analytics, and reports in multiple formats.",
  },
  {
    icon: Cloud,
    title: "Cloud Functions",
    description:
      "Serverless integrations with AWS Lambda, Google Cloud, and Azure.",
  },
  {
    icon: Lock,
    title: "OAuth 2.0",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-white/60 max-w-3xl mx-auto mb-12">
              Seamlessly integrate Narxu AI with 100+ tools you already use. No
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-white/60 max-w-2xl mx-auto">
                Build custom integrations with our powerful API. Full
                documentation and SDKs available.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <h2 className="text-3xl font-bold mb-4">
                    Why Integrate with Narxu?
                  </h2>
                  <p className="text-white/60 mb-6">
                    Get the most out of your existing tools by connecting them
                    with Narxu AI. Automate workflows, sync data, and provide
