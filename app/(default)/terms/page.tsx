...
export const metadata: Metadata = {
  title: "Terms of Service | Narxu - AI Automation Solutions",
  description:
    "Read the terms and conditions for using Narxu's AI automation services. Understand your rights and responsibilities as a user.",
  keywords: [
    "terms of service",
  ...
  openGraph: {
    title: "Terms of Service | Narxu",
    description: "Terms and conditions for using Narxu AI services.",
    type: "website",
  },
};
...
const terms = [
  ...
  },
  {
    ...
    content:
      "Narxu reserves the right to modify, suspend, or discontinue any part of the services at any time without prior notice. We may also impose limits on certain features or restrict access to parts of the services without notice or liability. We will make reasonable efforts to notify users of significant changes that may affect their use of the services.",
  },
  {
    icon: Gavel,
    title: "7. Limitation of Liability",
    content:
      "To the fullest extent permitted by law, Narxu shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use the services. Our total liability shall not exceed the amount paid by you for the services in the twelve months preceding the claim. Some jurisdictions do not allow limitations on implied warranties or exclusions of certain damages.",
  },
  {
    icon: HelpCircle,
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/60 max-w-2xl mx-auto">
              Please read these terms carefully before using our AI automation
              services.
            </p>
          ...
          <div className="mt-12 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8">
            ...
            <ul className="space-y-2 text-white/60">
              <li>Email: legal@Narxu.ai</li>
              <li>
                Address: 123 AI Innovation Hub, Tech District, San Francisco, CA
                94105
              </li>
