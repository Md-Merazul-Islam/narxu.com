            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                ...
                <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                  Clutch by Narxu handles all your WhatsApp, Messenger, and
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    ...
                    phone, and social media. Clutch By Narxu manages bookings,
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Clutch By Narxu automatically schedules service
                ...
                >
                  ...
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">
                    Stop wasting time on repetitive questions. Clutch By Narxu
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        Clutch By Narxu responds to 50+ common questions about
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-sm leading-relaxed ml-12">
                        ...
                        Clutch By Narxu handle the tire kickers
                      </p>
                    </div>
