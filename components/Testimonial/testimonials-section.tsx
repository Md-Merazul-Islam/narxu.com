...
const testimonials = [
  {
    text: "We went from missing 70% of after-hours web inquiries to capturing every single lead. Project consultations increased 65% in the first month with Cliste's AI handling initial qualification.",
    name: "Sarah Chen",
    role: "Digital Agency Owner",
    service: "AI Chatbots & Web Development"
  },
  {
    text: "Our website traffic grew by 140% in 6 months with Cliste's SEO optimization. The AI chatbot handles 80% of our customer inquiries, freeing up our team for complex projects.",
    name: "Mike Rodriguez",
    role: "Tech Startup Founder",
    service: "SEO & AI Solutions"
  },
  {
    text: "Cliste built our mobile app from scratch and integrated it with our existing systems. The 24/7 support has been invaluable for ongoing maintenance and updates.",
    name: "Jennifer Walsh",
  ...
  {
    text: "Cliste redesigned our entire digital presence - website, social media, and customer portal. The seamless integration across platforms has boosted our conversion rates by 85%.",
    name: "James Wilson",
  ...
  {
    text: "The startup showcase platform Cliste built helped us secure funding and partnerships. Their end-to-end digital solution took our business to the next level.",
    name: "Michael Torres",
...
export async function TestimonialsSection() {
  return (
    <section id="testimonials" className="relative pt-16 pb-16 px-4 sm:px-6 lg:px-8">
      {/* Grid Background */}
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-32">
          ...
          <p className="text-xl text-white/70 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-400">
            Discover how businesses are transforming their digital presence with our complete AI and development solutions
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16 max-w-4xl mx-auto animate-fade-in-up delay-600">
          {[
            ...
            <div key={index} className="text-center bg-white/5 rounded-lg p-4 backdrop-blur-sm border border-white/10">
              <div className="text-2xl font-bold text-white mb-1">{service.count}</div>
        ...
        <div className="text-center mt-16 animate-fade-in-up delay-1000">
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-white/70 mb-6 max-w-md mx-auto">
              Join 300+ businesses that have accelerated their growth with our complete digital solutions.
            </p>
